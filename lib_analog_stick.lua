...
function NewStick( Props )
        ...
        Group.Border:setFillColor  (Props.R,Props.G,Props.B,46/255)
        Group.Border:setStrokeColor(Props.R,Props.G,Props.B,255/255)
        Group:insert(Group.Border)
 
        Group.Thumb = display.newCircle(0,0,Props.thumbSize)
        Group.Thumb.strokeWidth = 1
        Group.Thumb:setFillColor  (Props.R,Props.G,Props.B,96/255)
        Group.Thumb:setStrokeColor(Props.R,Props.G,Props.B,255/255)
        Group.Thumb.x0 = 0
        Group.Thumb.y0 = 0
