...
-- local shadows=Shadows:new(1,{0.08,0.08,0.08}) 
-- local light1=shadows:AddLight(3,{1,1,1},0.4) 
-- local light2=shadows:AddLight(2,{1,1,0},0.4) 
-- light2.xLoc=990 
-- light2.yLoc=540 
-- local light3=shadows:AddLight(2,{1,1,0},0.4) 
-- light3.xLoc=1350 
-- light3.yLoc=1890 
-- local lights={light2,light3} 
-- shadows:AllLightsOff() 
-- camera:add(shadows,1) 
	...
	if e.phase=="ended" then 
		...
		if actions[interactionX][interactionY]~=nil then 
			...
			elseif actions[interactionX][interactionY][1][1]=="enter" then	
				...
				------***********************place lvl name in mapOrigin************************
				------***********************place lvl name in mapOrigin************************
				local missionParams={effect="fade",time=200,params={mapOrigin="",mapToLoad=actions[interactionX][interactionY][1][2],gridX=actions[interactionX][interactionY][1][3],gridY=actions[interactionX][interactionY][1][4]}}
