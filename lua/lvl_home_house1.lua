	...
	if e.phase=="ended" then 
		...
		if actions[interactionX][interactionY]~=nil then 
			...
			elseif actions[interactionX][interactionY][1][1]=="enter" then	
				-- paused=true
				local missionParams={effect="fade",time=200,params={mapOrigin="lvl_home_house1",mapToLoad=actions[interactionX][interactionY][1][2],gridX=actions[interactionX][interactionY][1][3],gridY=actions[interactionX][interactionY][1][4]}}
...
function scene:create( event ) 
	...
	CMap.createMap("lvl_home_house1.txt") 
	map=CMap.map
	...
	actions[6][2]={{"enter","lvl_home",28,29}}
	actions[3][11]={{"enter","lvl_home",28,35}}
